 ...
 * Modified on: March 26, 2015
 * Modifications: Added category, elevation and address attributes to the Waypoint and to its init method
 */
...
- initWithLat: (double) lat lon: (double) lon elevation: (double) elevation name: (NSString*)  name  address:(NSString *)address category:(NSString *)category {
    if ( (self = [super init]) ) {
        self.lat = lat;
        self.lon = lon;
